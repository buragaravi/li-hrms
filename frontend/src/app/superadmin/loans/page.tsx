...
/**
 * Provides a tabbed UI to view, apply for, and manage loans and salary advances.
 *
 * Renders lists for loans, salary advances, and pending approvals and exposes dialogs and inline forms
 * for viewing details, editing applications, approving/rejecting/forwarding, recording payments,
 * releasing disbursements, and performing early settlements. Includes employee selection, eligibility
 * calculation for salary advances, interest/EMI previews, transaction history, and status-aware actions.
 *
 * @returns The LoansPage React element that renders the loan and salary-advance management interface.
 */
