...
/**
 * Render a two-step modal UI for selecting employee fields, downloading a prefilled template, and uploading an Excel file to perform a bulk employee update.
 *
 * The component manages loading available field settings, selection of updatable fields (with certain fields restricted), template download to continue to the upload step, file selection, upload processing, and display of a processing summary or errors.
 *
 * @param onClose - Callback invoked when the modal is dismissed or cancelled
 * @param onSuccess - Callback invoked shortly after a successful bulk update completes
 * @returns The modal UI element for performing bulk employee updates
 */
